...
class TestTradeExecutorIntegration:
    ...
    def test_portfolio_snapshot_stress(self):
        ...
        assert pytest.approx(snap_basic['cash'], rel=1e-3) == 45000.0  # Allow small rounding differences
...
class TestErrorRecoveryScenarios:
    ...
    def test_extreme_market_conditions(self):
        ...
        with patch('wsapp_gui.trade_executor.TradeExecutor._load_ledger'):
            ...
            executor_penny.configure(enabled=True, mode='paper', base_size=100.0, paper_starting_cash=1000.0)
            ...
            executor_expensive.configure(enabled=True, mode='paper', base_size=1000.0, paper_starting_cash=1000.0)
